      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <a href="#home" className="text-xl font-display font-bold text-portfolio-primary">
            My<span className="text-portfolio-dark"> Portfolio</span>
          </a>
          ...
          <nav className="hidden md:flex space-x-4 lg:space-x-6 items-center">
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    isActive ? 'text-portfolio-primary border-b-2 border-portfolio-primary' : 'text-gray-600'
                  )}
                >
                  {item.name}
                </a>
            ...
            <a href="#download" className="btn-primary ml-4 text-sm font-medium">
              Resume
            </a>
          </nav>
            ...
            return (
              <a
                ...
                className={cn(
                  ...
                  isActive ? 'text-portfolio-primary' : 'text-gray-600'
                )}
              >
                {item.name}
              </a>
